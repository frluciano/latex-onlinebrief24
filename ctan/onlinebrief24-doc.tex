...
\texttt{\string\setfromname\{...\}} & Deprecated legacy alias. Emits a class
warning; use \texttt{\string\setfromfirstname} and
\texttt{\string\setfromlastname} instead. \\
\midrule
...
be called in the preamble. Using \texttt{\string\addfooteritem} without the
\texttt{modern} option emits a class warning and has no effect.
